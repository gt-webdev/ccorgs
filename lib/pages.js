...
exports.configure = function(app) {
  ...
  //app.get('/:vanity/events', events.vanityPrefixRedirect); //redirect
  app.get('/:vanity/events/:evid', events.vanityPrefixRedirect); //redirect
  app.get('/:vanity/now', events.vanityPrefixRedirect); //redirect
  ...
  app.get('/orgs/:vanity/events/:evid', events.eventById);
