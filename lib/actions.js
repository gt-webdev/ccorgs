...
exports.configure = function(app) {
  ...
  app.put('/orgs/:vanity/events/:evid/resources/:resid', auth.requiresMod, events.editResource);
  app.delete('/orgs/:vanity/events/:evid/resources/:resid', auth.requiresMod, events.deleteResource);
